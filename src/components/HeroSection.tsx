...
>
          ...
          >
            {['React.js', 'Express.js', 'Next.js', 'TypeScript', 'MongoDB', 'PostgreSQL', 'MySQL'].map((tech, index) => (
              <motion.span
                ...
                className="px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200"
              >
                {tech}
              </motion.span>
            ))}
  ...
  whileHover={{ scale: 1.05, y: -2 }}
  whileTap={{ scale: 0.95 }}
  href="/cv.pdf"  // <-- Public folder ka path
  download        // <-- Ye attribute file download karayega
  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
>
  Download CV
  <ChevronDown size={20} />
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="p-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200"
                aria-label={label}
              >
                <Icon size={24} />
              </motion.a>
